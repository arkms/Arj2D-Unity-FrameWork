...
namespace BlowFishCS
{
    public class BlowFish
    {
        ...
        #region CONVERTS
        public string Convert_Aint(int[] ar)
        {
            return System.String.Join("_", new List<int>(ar).ConvertAll(i => i.ToString()).ToArray());
        }

        public string Convert_Afloat(float[] ar)
        {
            return System.String.Join("_", new List<float>(ar).ConvertAll(i => i.ToString()).ToArray());
        }

        public string Convert_ABool(bool[] ar)
        {
            return System.String.Join("_", new List<bool>(ar).ConvertAll(i => i.ToString()).ToArray());
        }

        public int[] Desconvert_Aint(string tx)
        {
            ...
            while (lasti < tx.Length)
            {
                ...
                if (index != -1)
                {
                    int num = int.Parse(tx.Substring(lasti, index - lasti));
                    lista.Add(num);
                    lasti = index + 1;
                }
                else
                {
                    int num = int.Parse(tx.Substring(lasti, tx.Length - lasti));
                    lista.Add(num);
                    lasti = tx.Length;
                }
            }
        ...
        public float[] Desconvert_Afloat(string tx)
        {
        ...
        public bool[] Desconvert_Abool(string tx)
        {
            ...
            while (lasti < tx.Length)
            {
                ...
                if (index != -1)
                {
                    bool num = bool.Parse(tx.Substring(lasti, index - lasti));
                    lista.Add(num);
                    lasti = index + 1;
                }
                else
                {
                    bool num = bool.Parse(tx.Substring(lasti, tx.Length - lasti));
                    lista.Add(num);
                    lasti = tx.Length;
                }
            }
    ...
    public static class PlayerPreferX
    {
        ...
        public static int GetInt(BlowFish b, string _key, int _default = 0)
        {
            if (PlayerPrefs.HasKey(_key))
                return int.Parse(b.Decrypt_CBC(PlayerPrefs.GetString(b.Decrypt_CBC(_key))), System.Globalization.NumberStyles.Integer);
            return _default;
        }
        ...
        {
            if (PlayerPrefs.HasKey(_key))
                return b.Desconvert_Aint(b.Decrypt_CBC(PlayerPrefs.GetString(b.Decrypt_CBC(_key))));
            return _default;
        }
        ...
        {
            if (PlayerPrefs.HasKey(_key))
                return bool.Parse(b.Decrypt_CBC(PlayerPrefs.GetString(b.Decrypt_CBC(_key))));
            return _default;
        }
        ...
        {
            if (PlayerPrefs.HasKey(_key))
                return b.Desconvert_Abool(b.Decrypt_CBC(PlayerPrefs.GetString(b.Decrypt_CBC(_key))));
            return _default;
        }
        ...
        {
            if (PlayerPrefs.HasKey(_key))
                return float.Parse(b.Decrypt_CBC(PlayerPrefs.GetString(b.Decrypt_CBC(_key))));
            return _default;
        }
        ...
        {
            if (PlayerPrefs.HasKey(_key))
                return b.Desconvert_Afloat(b.Decrypt_CBC(PlayerPrefs.GetString(b.Decrypt_CBC(_key))));
            return _default;
        }
    }
}
